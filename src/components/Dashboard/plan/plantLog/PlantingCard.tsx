    ...
    >
      ...
      <div className='mb-4 flex items-start justify-between border-b border-gray-300'>
        ...
        <div className='relative inline-block group text-sm'>
          ...
          {isCropStillActive && (
            <span
              className={`absolute right-0 bottom-full w-max whitespace-normal rounded ${bgAccent} px-2 py-1 text-xs text-white opacity-0 translate-y-1 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-200 ease-out z-10 shadow-lg`}
            >
